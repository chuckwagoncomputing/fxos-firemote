...
baseProtocol.prototype = {
  ...
  // read-only variables
  transportService     : navigator.mozTCPSocket,
  toUTF8               : Utf8,
  fromUTF8             : Utf8,
  ...
  setupConnect : function(reconnect) {
    ...
    this.networkTimeoutID += 1;                                                  // just in case we have timeouts from previous connection
...
function setProtocol(protocol) {
  var protocolMap = {
    'telnet' : { 'transport': telnetMoz,   'observer': telnetObserver },
